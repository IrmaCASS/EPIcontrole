  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: _handleTap,
          // AnimatedContainer troca o tamanho e a cor do botão de forma suave.
                ...
                IgnorePointer(
                  child: AnimatedOpacity(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: AppTheme.kBrancoAcizentado.withValues(alpha: 0.7),
                      ),
                    ),
                  ),
                ),
